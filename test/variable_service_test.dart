...
final _stepName1 = "Scan card 1";
final _stepName2 = "Scan card 2";

void main() {
  group("VariableService", () {
    prepareTestForVariableService();
    test("Find the variable into the step", findInStep);
    test("Find the variable from another step", findFromAnotherStep);
    test("Find the variable by parent", findByParent);
  });
}

void prepareTestForVariableService() {
  final map = jsonDecode(json);
  VariableService.registerStep(_stepName1, (map["steps"] as List)[0]);
  VariableService.registerStep(_stepName2, (map["steps"] as List)[1]);
}
