package com.tangem.flutter.plugin.sdk
...
/** SdkPlugin */
public class SdkPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  private lateinit var sdk: TangemSdk

  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    val channel = MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "sdk")
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      ...
      channel.setMethodCallHandler(SdkPlugin())
    }
  }
}
