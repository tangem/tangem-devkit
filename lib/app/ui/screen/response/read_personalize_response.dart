      ...
      child: ListBody(
        children: <Widget>[
          ...
          ResponseTextWidget(
            ...
            _card.firmwareVersion.stringValue,
...
class CardDataResponseWidget extends StatelessWidget {
  final CardConfigData? _cardData;
...
class SigningMethodsResponseWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (_card.settings.defaultSigningMethods == null) return StubWidget();
    ...
    SigningMethod.values.enumToStringList().forEach((element) {
      widgets.add(ResponseCheckboxWidget(element, _card.settings.defaultSigningMethods!.contains(element)));
    });
