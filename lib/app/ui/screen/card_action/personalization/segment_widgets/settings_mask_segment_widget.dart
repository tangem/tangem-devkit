    ...
    return Column(
      children: <Widget>[
        ...
        SwitchWidget(
          ...
          settingMask.prohibitPurgeWallet,
          initialData: false,
        ).withUnderline(),
        SwitchWidget(
