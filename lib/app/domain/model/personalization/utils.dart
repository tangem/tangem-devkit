...
class Utils {
  ...
  static Map<String, dynamic> createPersonalizationCommandConfig(
    PersonalizationCardConfig config, [
    PersonalizationIssuer? issuer,
    PersonalizationAcquirer? acquirer,
    PersonalizationManufacturer? manufacturer,
  ]) {
    final configCopy = PersonalizationCardConfig.fromJson(config.toJson());
    configCopy.curveID = configCopy.curveID.capitalize();
    if (configCopy.cardData.date.isNullOrEmpty()) {
      configCopy.cardData.date = DateFormat("yyyy-MM-dd").format(DateTime.now());
    }
    ...
    return {
      TangemSdk.cardConfig: configCopy.toJson(),
  ...
  static PersonalizationIssuer createDefaultIssuer() {
  ...
  static PersonalizationAcquirer createDefaultAcquirer() {
  ...
  static PersonalizationManufacturer createDefaultManufacturer() {
    final publicKey =
    ...
    return PersonalizationManufacturer("Tangem", KeyPairHex(publicKey, privateKey));
  }
}
...
class CommandJsonTest {
  ...
  static String personalize = '''{
    "config": $defaultPersonalizationJson,
