class Languages {
  ...
  "screen_response_scan": "Read Response",
  "screen_response_sign": "Sign Response",
  "screen_response_personalization": "Personalization Response",
  "screen_response_depersonalization": "Depersonalization Response",
  "screen_response_create_wallet": "Create Wallet Response",
  "screen_response_purge_wallet": "Purge Wallet Response",
  "screen_response_read_issuer_data": "Read Issuer Data Response",
  "screen_response_write_issuer_data": "Write Issuer Data Response",
  "screen_response_read_issuer_extra_data": "Read Issuer Extra Data Response",
  "screen_response_read_user_data": "Read User Data Response",
  ...
  "action_wallet_create": "Create Wallet",
  "desc_action_wallet_create": "If the card has an ‘Empty’ state, this command will create a new wallet, changing a state to ‘Loaded’.",
  "action_wallet_purge": "Purge Wallet",
  "desc_action_wallet_purge": "This command deletes all wallet data. If ‘IsReusable‘ flag was enabled during personalization, the card changes state to ‘Empty’ and a new wallet can be created by Create Wallet Command.",
  ...
  "pers_item_need_activation": "Need activation",
  "desc_pers_item_need_activation": "",
